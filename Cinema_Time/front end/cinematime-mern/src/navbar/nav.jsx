...
function Navct() {
  return (
    <>
      <nav class="navbar navbar-expand-lg position-fixed top-0 start-0 end-0 sticky-top navbar-dark navbg">
        <div class="container-fluid">
          <Link class="navbar-brand text-warning" to="/">Cinema Time</Link>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="d-flex justify-content-between">
              ...
              <button type="button" class="btn btn-outline-warning rounded-5 mx-4"><FontAwesomeIcon icon={faStar} /></button>
